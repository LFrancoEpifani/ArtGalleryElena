...
export default function About() {
  return (
    <div className=''>
      ...
      <section className='grid grid-cols-1 md:grid-cols-5 gap-6 border-y-2 border-black items-center justify-between'>
        ...
        <div className='md:col-span-3 h-[95vh] w-full text-center'>
          <div className='max-w-2xl p-6 md:p-12 lg:my-4 2xl:max-w-full flex flex-col items-center justify-center 2xl:p-20'>
            <h3 className='sorts text-4xl md:text-4xl text-center uppercase 2xl:my-4 2xl:text-[55px]'>Elena Salova</h3>
            <p className='text-center leading-8 my-4 lg:leading-10  lg:text-[20px] 2xl:my-8 text-gray-800 2xl:leading-10 2xl:text-[24px]'>
            ...
            <a href="#yoga">
              <Icon className='text-center text-2xl lg:text-5xl lg:my-4 md:text-5xl md:my-2 2xl:text-7xl 2xl:my-2' icon='ei:arrow-down' />
              </a>
          </div>
        </div>
      </section>
          ...
          <div className='max-w-2xl p-6 md:p-12 2xl:max-w-full flex flex-col items-center justify-center 2xl:p-20'>
           ...
           <a href="https://www.instagram.com/elena.art.studio.es/">
             <button className='flex justify-center items-center gap-1'>
              <p className='border-b-2 border-black lg:text-2xl lg:my-2 2xl:text-[25px] 2xl:my-4'>
              Send me a message
              </p>
      ...
      <img
        ...
        />
         <div className='md:col-span-3 h-[95vh] w-full text-center'>
          <div className='max-w-2xl p-6 md:p-12 2xl:max-w-full lg:my-8 flex flex-col items-center justify-center 2xl:p-20'>
            ...
            <button className='flex justify-center items-center gap-1'>
              <p className='border-b-2 border-black lg:text-2xl lg:my-6 2xl:text-[25px] 2xl:my-4'>
              Work with me
              </p>
              <Icon className='text-xl 2xl:text-2xl' icon="iconamoon:arrow-top-right-1-light" />
            </button>
    ...
    <div className='col-span-2 text-center'>
        <h3 className='text-xl font-bold my-4 lg:text-2xl 2xl:text-4xl'>Inesa Kochur</h3>
        <p className='w-full px-4 leading-8 lg:leading-10 lg:text-lg 2xl:leading-10 2xl:text-2xl'>“The artwork “Open” represents a traditional doorknob in the form of a hand which one can spot on the entrances of ancient buildings in Seville. The color palette of gold and black gives a touch of royalty and aristocracy. “</p>
    </div>
    ...
    <div className='col-span-2 text-center'>
        <h3 className='text-xl font-bold my-4 lg:text-2xl  2xl:text-4xl'>Miguel Valdayo Boza</h3>
        <p className='w-full px-4 leading-8  lg:leading-10 lg:text-lg 2xl:leading-10 2xl:text-2xl'>“This work, made by the painter Elena,  presents us with a painting full of meaning and with multiple readings, all of them interconnected in a general whole that tells us about the cultural heritage that we enjoy in Andalusia and wonderfully resolved in a format in which each and every one of the elements that define the work is easily identifiable.” </p>
    </div>
</div>
